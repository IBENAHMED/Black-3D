          ...
          {active === item && children && (
            <div className='absolute top-[calc(100%_+_1.2rem)] left-1/2 transform -translate-x-1/2 pt-4'>
              <motion.div
                ...
                layoutId='active'
                className='bg-white  text-black  rounded-2xl overflow-hidden border border-black/[0.2] dark:border-white/[0.2] shadow-xl'
              >
                <motion.div
                  layout
...
export const Menu = ({setActive, children}: {setActive: (item: string | null) => void; children: React.ReactNode}) => {
  return (
    <nav
      ...
      className='relative  text-white rounded-full boder   border-white/[0.2] bg-white bg-opacity-20 backdrop-blur-lg shadow-input flex justify-center space-x-4 px-8 py-6 '
    >
      {children}
    </nav>
  )
